...
// Centralita.cpp : define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CCentralitaApp
...
// El único objeto CCentralitaApp

CCentralitaApp theApp;


// Inicialización de CCentralitaApp
